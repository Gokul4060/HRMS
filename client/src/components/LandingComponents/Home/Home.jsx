      ...
      <section className="mx-auto -mt-11 py-6 px-4 md:py-12 md:px-8 lg:flex lg:items-center">
        <div className="space-y-6 flex-1 text-center lg:text-left">
          <a
            ...
            className="inline-flex items-center gap-x-3 rounded-full p-1 pr-5 border border-gray-800 text-sm font-medium duration-150 hover:bg-gray-50 mt-5"
          >
          ...
          <h1 className="text-black font-bold text-3xl md:text-4xl lg:text-5xl mt-9">
            HR Software India
            <span className="text-customplam"> Digital workplace</span>
          </h1>
          <p className="text-gray-700 mx-auto  leading-relaxed mt-6">
            ...
            together. No matter the size of your business, our HRMS software in
            India is suitable for addressing your human resource management
            processes for smooth operation. Integrated with software like Time
            Attendance, Payroll, Leave, Claims, and Appraisal.
          </p>
          
          <div className="flex flex-col items-center gap-y-4 lg:flex-row lg:items-center lg:gap-x-4 mt-28">
            <button
              onClick={() => {
                navigate("/log-in");
              }}
              className="flex items-center justify-center gap-x-2 py-2 px-5 shadow-lg text-white font-medium bg-customplam duration-150 hover:bg-green-700 active:bg-customplam rounded-full md:inline-flex"
            >
              Get started
              <svg
        ...
        <div className="flex-1 text-center lg:text-left mt-10 lg:mt-0 lg:ml-10">
          <img
            src={img}
            className="w-full max-w-xl mx-auto sm:w-10/12 lg:w-full"
